...
aarch64-none-elf-ld --no-warn-rwx-segments -T linker/linker.ld build/boot.o build/main.o build/uart.o build/mkmau.o build/mkmau_utils.o build/mobilemkMAU.o build/dbt.o build/alignbyte.o -o build/boot.elf
